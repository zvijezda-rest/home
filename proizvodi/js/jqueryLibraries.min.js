 ...
 */
(function(e){"use strict";e.fn.cmsmsFixedHeaderScroll=function(t){var n={headerTop:".header_top",headerMid:".header_mid",headerBot:".header_bot",navBlock:"nav",navList:"#navigation",navTopList:"#top_line_nav",respNavButton:".responsive_nav",respTopNavButton:".responsive_top_nav",fixedClass:".fixed_header",fixedClassBlock:"#page",respHideBlocks:"",maxWidthMid:checker.ua.safari && !checker.ua.chrome ? 1024 : 1007,maxWidthBot:checker.ua.safari && !checker.ua.chrome ? 1024 : 1007,changeTopHeight:true,changeMidHeight:true,mobileDisabled:true},r=this,i={},s=i;i={init:function(){i.options=i.o=e.extend({},n,t);i.el=r;i.vars=i.v={};i.v.newTopHeight=0;i.v.newMidHeight=50;i.setHeaderVars();i.startHeader()},setHeaderVars:function(){i.v.headerMidString=i.o.headerMid;i.v.headerTop=i.el.find("> "+i.o.headerTop);i.v.headerMid=i.el.find("> "+i.v.headerMidString);i.v.headerBot=i.el.find("> "+i.o.headerBot);i.v.respNavButton=i.el.find(i.o.respNavButton);i.v.respTopNavButton=i.el.find(i.o.respTopNavButton);i.v.respHideBlocks=e(i.o.respHideBlocks);i.v.navListString=i.o.navList;i.v.navTopListString=i.o.navTopList;i.v.navBlockString=i.o.navBlock;i.v.navBlock=i.el.find(i.v.navListString).parents(i.v.navBlockString);i.v.navTopBlock=i.el.find(i.v.navTopListString).parents(i.v.navBlockString);i.v.midChangeHeightBlocksResp=e(i.v.headerMidString+", "+i.v.headerMidString+" .header_mid_outer, "+i.v.headerMidString+" "+i.v.navListString+", "+i.v.headerMidString+" "+i.v.navListString+" > li, "+i.v.headerMidString+" "+i.v.navListString+" > li > a, "+i.v.headerMidString+" "+i.v.navListString+" > li > a > span.nav_bg_clr");i.v.topHeight=0;i.v.midHeight=0;i.v.botHeight=0;i.v.win=e(window);i.v.winScrollTop=i.v.win.scrollTop();i.v.winMidScrollTop=i.v.winScrollTop-i.v.topHeight-i.v.midHeight;i.v.isMobile="ontouchstart"in document.documentElement},startHeader:function(){if(i.v.headerTop.length>0){i.v.topHeight=Number(i.v.headerTop.attr("data-height"))}if(i.v.headerMid.length>0){i.v.midHeight=Number(i.v.headerMid.attr("data-height"))}if(i.v.headerBot.length>0){i.v.botHeight=Number(i.v.headerBot.attr("data-height"))}if(i.v.winScrollTop==0){i.el.css({opacity:1})}i.attachEvents();i.v.win.trigger("scroll")},attachEvents:function(){i.v.respNavButton.bind("click",function(){if(i.v.respNavButton.is(":not(.active)")){i.v.navBlock.css({display:"block"});i.v.respHideBlocks.css({display:"none"});i.v.respNavButton.addClass("active")}else{i.v.navBlock.css({display:"none"});i.v.respHideBlocks.css({display:"block"});i.v.respNavButton.removeClass("active")}return false});i.v.respTopNavButton.bind("click",function(){if(i.v.respTopNavButton.is(":not(.active)")){i.v.navTopBlock.css({display:"block"});i.v.respHideBlocks.css({display:"none"});i.v.respTopNavButton.addClass("active")}else{i.v.navTopBlock.css({display:"none"});i.v.respHideBlocks.css({display:"block"});i.v.respTopNavButton.removeClass("active")}return false});i.v.win.bind("scroll",function(){if(i.el.parents(i.o.fixedClassBlock).is(":not("+i.o.fixedClass+")")||i.o.mobileDisabled&&i.v.isMobile){return false}if(i.v.win.width()>i.o.maxWidthMid){i.getScrollTop()}});i.v.win.bind("resize",function(){if(i.v.headerBot.length>0){i.headerResize(i.o.maxWidthBot)}else{i.headerResize(i.o.maxWidthMid)}})},getScrollTop:function(){i.v.winScrollTop=i.v.win.scrollTop();i.v.winMidScrollTop=i.v.winScrollTop-i.v.topHeight-i.v.midHeight;if(i.v.winScrollTop>i.v.topHeight+i.v.midHeight+i.v.botHeight){i.el.css({marginTop:-(i.v.topHeight+i.v.midHeight+i.v.botHeight),paddingTop:i.v.botHeight,opacity:1}).addClass("navi_scrolled")}else{i.el.removeClass("navi_scrolled").css({marginTop:-i.v.winScrollTop,paddingTop:0,opacity:1})}},headerResize:function(e){if(i.v.win.width()>e){i.v.navBlock.removeAttr("style");i.v.respHideBlocks.removeAttr("style");i.v.respNavButton.removeClass("active");i.getScrollTop()}else{i.el.removeAttr("style").removeClass("navi_scrolled").css({opacity:1})}}};i.init()}})(jQuery);
